...
model_calibration(solver_fname = "net/COVID-19Piemonte.solver",
                  f_time = 40,
                  s_time = 1,
                  parameters_fname = "input/plistCalibration.csv",
                  functions_fname = "R/Functions.R",
                  distance_measure_fname = "R/msqd.R",
...
source('./R/plot/PlotModelAnalysis.R')
...
model_analysis(solver_fname =  "./net/COVID-19Piemonte.solver",
               ...
               s_time = 1,
               n_config = 200,
               parameters_fname = "input/plistWIAlpha.csv",
               functions_fname = "R/Functions.R",
               ini_v = optim,
